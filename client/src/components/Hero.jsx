...
const Hero = () => {
    ...
    return (
        <div className='h-screen flex flex-col items-center justify-center gap-14 bg-light text-center'>
            ...
            <h1 className='text-4xl md:text-5xl font-bold'>Welcome to Car Rental</h1>
...
gap-10 min-md:ml-8'>
                ...
                <button className='flex items-center justify-center gap-1 px-9 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-full shadow-md hover:shadow-xl hover:scale-105 transition-all duration-300 mr-1'> 
